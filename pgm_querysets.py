...
qs = (Queryset("hh_fat_pgm_baseline", "priogrid_month")
...
# log variables
if True:
    qs = (Queryset("hh_fat_pgm_conflictlong", "priogrid_month")
          ...
          .with_column(Column("decay_ged_sb_100", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                       .transform.missing.replace_na()
          ...
          .with_column(Column("decay_ged_sb_500", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                       .transform.missing.replace_na()
          ...
          .with_column(Column("decay_ged_os_25", from_table="ged2_pgm", from_column="ged_os_best_sum_nokgi")
                       .transform.missing.replace_na()
                       .transform.bool.gte(25)
                       .transform.temporal.time_since()
                       .transform.temporal.decay(12)
          ...
          .with_column(Column("decay_ged_os_100", from_table="ged2_pgm", from_column="ged_os_best_sum_nokgi")
                       .transform.missing.replace_na()
                       .transform.bool.gte(100)
                       .transform.temporal.time_since()
                       .transform.temporal.decay(12)
          ...
          .with_column(Column("decay_ged_os_500", from_table="ged2_pgm", from_column="ged_os_best_sum_nokgi")
                       .transform.missing.replace_na()
                       .transform.bool.gte(500)
                       .transform.temporal.time_since()
                       .transform.temporal.decay(12)
          ...
          .with_column(Column("decay_ged_ns_25", from_table="ged2_pgm", from_column="ged_ns_best_sum_nokgi")
                       .transform.missing.replace_na()
                       .transform.bool.gte(25)
                       .transform.temporal.time_since()
                       .transform.temporal.decay(12)
          ...
          .with_column(Column("decay_ged_ns_100", from_table="ged2_pgm", from_column="ged_ns_best_sum_nokgi")
                       .transform.missing.replace_na()
                       .transform.bool.gte(100)
                       .transform.temporal.time_since()
                       .transform.temporal.decay(12)
          ...
          .with_column(Column("decay_ged_ns_500", from_table="ged2_pgm", from_column="ged_ns_best_sum_nokgi")
                       .transform.missing.replace_na()
                       .transform.bool.gte(500)
                       .transform.temporal.time_since()
                       .transform.temporal.decay(12)
...
qs = (Queryset("fat_escwa_drought_vulnerability_pgm", "priogrid_month")
      ...
      .with_column(
    Column("count_moder_drought_prev10", from_table="hack_temp_escwa_pgm_pgm", from_column="count_moder_drought_prev10")
    .transform.missing.replace_na(0)
    )
      ...
      .with_column(
    Column("spei1_gs_prev10_anom", from_table="hack_temp_escwa_pgm_pgm", from_column="spei1_gs_prev10_anom")
    .transform.missing.replace_na(0)
    )
      ...
      .with_column(
    Column("spei1gsy_lowermedian_count", from_table="hack_temp_escwa_pgm_pgm", from_column="spei1gsy_lowermedian_count")
    .transform.missing.replace_na(0)
    )
      ...
      .with_column(
    Column("tlag_12_harvarea_maincrops", from_table="hack_temp_escwa_pgm_pgm", from_column="tlag_12_harvarea_maincrops")
    .transform.missing.replace_na(0)
    )
      .with_column(
    Column("tlag_12_irr_maincrops", from_table="hack_temp_escwa_pgm_pgm", from_column="tlag_12_irr_maincrops")
    .transform.missing.replace_na(0)
    )
      .with_column(
    Column("tlag_12_rainf_maincrops", from_table="hack_temp_escwa_pgm_pgm", from_column="tlag_12_rainf_maincrops")
    .transform.missing.replace_na(0)
    )
...
qs = (Queryset("hh_fat_pgm_natsoc", "priogrid_month")
...
halflife6=6
halflife3=3
efold24=halflife24/np.log(2)
efold12=halflife12/np.log(2)
efold6=halflife6/np.log(2)
efold3=halflife3/np.log(2)
thetacrit_spatial=0.7
thetacrit_temporal=0.1
...
qs = (Queryset("hh_fat_pgm_broad", "priogrid_month")
...
qs = (Queryset("paola_fatalities_conflict_history", "priogrid_month")
      ...
      .with_column(Column("ln_ged_sb_tlag_1", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_2", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_3", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_4", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_5", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_6", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_7", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_8", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_9", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_10", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_11", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_tlag_12", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.tlag(12)
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_sb_decay_12_time_since", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.temporal.decay(12)
                   .transform.bool.gte(1)
                   .transform.missing.fill()
                   )
      ...
      .with_column(Column("ln_ged_sb_tlag_1_splag_1", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.tlag(1)
                   .transform.spatial.lag(1, 1, 0, 0)
      ...
      .with_column(Column("ln_ged_sb_splag_1", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.spatial.lag(1, 1, 0, 0)
                   .transform.ops.ln()
                   .transform.missing.fill()
                   )
      ...
      .with_column(Column("ln_ged_ns_tlag_1", from_table="ged2_pgm", from_column="ged_ns_best_count_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.tlag(1)
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_os_tlag_1", from_table="ged2_pgm", from_column="ged_os_best_count_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.tlag(1)
                   .transform.missing.fill()
      ...
      .with_column(Column("ln_ged_ns_decay_12_time_since", from_table="ged2_pgm", from_column="ged_ns_best_count_nokgi")
                   .transform.temporal.decay(12)
                   .transform.bool.gte(1)
                   .transform.missing.fill()
                   )

      .with_column(Column("ln_ged_os_decay_12_time_since", from_table="ged2_pgm", from_column="ged_os_best_count_nokgi")
                   .transform.temporal.decay(12)
                   .transform.bool.gte(1)
                   .transform.missing.fill()
                   )
      ...
      .with_column(Column("ln_ged_ns_splag_1", from_table="ged2_pgm", from_column="ged_ns_best_count_nokgi")
                   .transform.spatial.lag(1, 1, 0, 0)
                   .transform.ops.ln()
                   .transform.missing.fill()
                   )

      .with_column(Column("ln_ged_os_splag_1", from_table="ged2_pgm", from_column="ged_os_best_count_nokgi")
                   .transform.spatial.lag(1, 1, 0, 0)
                   .transform.ops.ln()
                   .transform.missing.fill()
                   )
      ...
      .with_column(Column("ln_ged_ns_tlag_1_splag_1", from_table="ged2_pgm", from_column="ged_ns_best_count_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.tlag(1)
                   .transform.spatial.lag(1, 1, 0, 0)
      ...
      .with_column(Column("ln_ged_os_tlag_1_splag_1", from_table="ged2_pgm", from_column="ged_os_best_count_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.tlag(1)
                   .transform.spatial.lag(1, 1, 0, 0)
      ...
      .with_column(Column("mov_avg_6_ged_best_sb", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
      ...
      .with_column(Column("mov_avg_36_ged_best_sb", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.moving_average(36)
                   )

      .with_column(Column("mov_sum_6_ged_best_sb", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.moving_sum(6)
                   )

      .with_column(Column("mov_sum_12_ged_best_sb", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
                   .transform.temporal.moving_sum(12)
                   )

      .with_column(Column("mov_sum_36_ged_best_sb", from_table="ged2_pgm", from_column="ged_sb_best_sum_nokgi")
                   .transform.ops.ln()
                   .transform.missing.fill()
...
qs = (Queryset("jim_pgm_conflict_treelag_d_1_d_2", "priogrid_month")
    # target variable
    .with_column(Column("ln_ged_sb_dep", from_table = "ged2_pgm", from_column = "ged_sb_best_sum_nokgi")
                 .transform.missing.replace_na()
                 .transform.ops.ln()
...
qs = (Queryset("jim_pgm_conflict_target_sptime_dist_nu1_10_001", "priogrid_month")
    # target variable
    .with_column(Column("ln_ged_sb_dep", from_table = "ged2_pgm", from_column = "ged_sb_best_sum_nokgi")
                 .transform.missing.replace_na()
                 .transform.ops.ln()
    ...
    .with_column(Column("sptime_dist_k1_ged_os", from_table = "ged2_pgm", from_column = "ged_os_best_sum_nokgi")
                 .transform.missing.replace_na()
                 .transform.spatial.sptime_dist(return_values,n_nearest,1.0,power)
                )
    .with_column(Column("sptime_dist_k1_ged_ns", from_table = "ged2_pgm", from_column = "ged_ns_best_sum_nokgi")
                 .transform.missing.replace_na()
                 .transform.spatial.sptime_dist(return_values,n_nearest,1.0,power)
                )
    .with_column(Column("sptime_dist_k1_ged_sb", from_table = "ged2_pgm", from_column = "ged_sb_best_sum_nokgi")
