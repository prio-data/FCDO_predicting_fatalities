...
# # Shorter conflict history, no-log depenent variadble
...
qs = (Queryset("fat_cm_conflict_history_exp", "country_month")
...
qs = (Queryset("hh_prs", "country_month")
    ...
    # From PRS
    .with_column(Column("bureaucracy_quality", from_table = "comparison_cm", from_column = "column_1")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("civil_disorder", from_table = "comparison_cm", from_column = "column_2")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("civil_war", from_table = "comparison_cm", from_column = "column_3")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("composite_risk_rating", from_table = "comparison_cm", from_column = "column_4")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("consumer_confidence", from_table = "comparison_cm", from_column = "column_5")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("contract_viability", from_table = "comparison_cm", from_column = "column_6")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("corruption", from_table = "comparison_cm", from_column = "column_7")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
#    .with_column(Column("cross-border_conflict", from_table = "comparison_cm", from_column = "column_8")
#                 .transform.missing.fill()
#                 .transform.missing.replace_na()
#                )
    .with_column(Column("democratic_accountability", from_table = "comparison_cm", from_column = "column_9")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("economic_risk_rating", from_table = "comparison_cm", from_column = "column_10")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("ethnic_tensions", from_table = "comparison_cm", from_column = "column_11")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("external_conflict", from_table = "comparison_cm", from_column = "column_12")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("financial_risk_rating", from_table = "comparison_cm", from_column = "column_13")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("foreign_pressures", from_table = "comparison_cm", from_column = "column_14")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("government_cohesion", from_table = "comparison_cm", from_column = "column_15")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("government_stability", from_table = "comparison_cm", from_column = "column_16")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("internal_conflict", from_table = "comparison_cm", from_column = "column_17")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("investment_profile", from_table = "comparison_cm", from_column = "column_18")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("law_and_order", from_table = "comparison_cm", from_column = "column_19")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("legislative_strength", from_table = "comparison_cm", from_column = "column_20")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("military_in_politics", from_table = "comparison_cm", from_column = "column_21")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("payment_delays", from_table = "comparison_cm", from_column = "column_22")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("political_risk_rating", from_table = "comparison_cm", from_column = "column_23")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("popular_support", from_table = "comparison_cm", from_column = "column_24")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("poverty", from_table = "comparison_cm", from_column = "column_25")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("religious_tensions", from_table = "comparison_cm", from_column = "column_26")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("repatriation", from_table = "comparison_cm", from_column = "column_27")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_budget_balance", from_table = "comparison_cm", from_column = "column_28")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_current_account_gdp", from_table = "comparison_cm", from_column = "column_29")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_current_account_xgs", from_table = "comparison_cm", from_column = "column_30")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_debt_service", from_table = "comparison_cm", from_column = "column_31")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_exchange_rate_stability", from_table = "comparison_cm", from_column = "column_32")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_foreign_debt", from_table = "comparison_cm", from_column = "column_33")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_gdp_growth", from_table = "comparison_cm", from_column = "column_34")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_inflation", from_table = "comparison_cm", from_column = "column_35")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_international_liquidity", from_table = "comparison_cm", from_column = "column_36")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("risk_for_percapita_gdp", from_table = "comparison_cm", from_column = "column_37")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("socioeconomic_conditions", from_table = "comparison_cm", from_column = "column_38")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("terrorism", from_table = "comparison_cm", from_column = "column_39")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("unemployment", from_table = "comparison_cm", from_column = "column_40")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
    .with_column(Column("war", from_table = "comparison_cm", from_column = "column_41")
                 .transform.missing.fill()
                 .transform.missing.replace_na()
                )
...
# # With ACLED as dependent variable


# ACLED,  version with non-log variables

qs = (Queryset("hh_fatalities_acled_nln", "country_month")


            # target variable
            .with_column(Column("acled_sb_dep", from_table = "acled2_cm", from_column = "acled_sb_fat")
                         .transform.missing.fill()
                        )                 
            ...
            .with_column(Column("ged_sb_tlag_1", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(1)
                         .transform.missing.fill()
                        )

            .with_column(Column("ged_sb_tlag_2", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(2)
                         .transform.missing.fill()
                        )

            .with_column(Column("ged_sb_tlag_3", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(3)
                         .transform.missing.fill()
                        )

            .with_column(Column("ged_sb_tlag_4", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(4)
                         .transform.missing.fill()
                        )

            .with_column(Column("ged_sb_tlag_5", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(5)
                         .transform.missing.fill()
                        )

            .with_column(Column("ged_sb_tlag_6", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(6)
                         .transform.missing.fill()
                        )
            ...
            .with_column(Column("ged_sb_decay_24_time_since", from_table = "ged2_cm", from_column = "ged_sb_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.time_since()
                         .transform.temporal.decay(24)
                        )
            ...
            .with_column(Column("acled_sb", from_table = "acled2_cm", from_column = "acled_sb_fat")
                         .transform.missing.fill()
                        )
            ...
            .with_column(Column("acled_sb_gov", from_table = "acled2_cm", from_column = "acled_bat_gov_fat")
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_sb_reb", from_table = "acled2_cm", from_column = "acled_bat_reb_fat")
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_ns", from_table = "acled2_cm", from_column = "acled_ns_fat")
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_os", from_table = "acled2_cm", from_column = "acled_os_fat")
                         .transform.missing.fill()
                        )

            # time-lagged by 0-2 independent variables
            .with_column(Column("ged_ns_tlag_1", from_table = "ged2_cm", from_column = "ged_ns_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(1)
                         .transform.missing.fill()
                        )               
            .with_column(Column("ged_ns_tlag_2", from_table = "ged2_cm", from_column = "ged_ns_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(2)
                         .transform.missing.fill()
                        )
            .with_column(Column("ged_os_tlag_1", from_table = "ged2_cm", from_column = "ged_os_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(1)
                         .transform.missing.fill()
                        )
            .with_column(Column("ged_os_tlag_2", from_table = "ged2_cm", from_column = "ged_os_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.tlag(2)
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_sb_tlag_1", from_table = "acled2_cm", from_column = "acled_sb_fat")
                         .transform.missing.fill()
                         .transform.temporal.tlag(1)
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_sb_tlag_2", from_table = "acled2_cm", from_column = "acled_sb_fat")
                         .transform.missing.fill()
                         .transform.temporal.tlag(2)
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_os_tlag_1", from_table = "acled2_cm", from_column = "acled_os_fat")
                         .transform.missing.fill()
                         .transform.temporal.tlag(1)
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_os_tlag_2", from_table = "acled2_cm", from_column = "acled_os_fat")
                         .transform.missing.fill()
                         .transform.temporal.tlag(2)
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_ns_tlag_1", from_table = "acled2_cm", from_column = "acled_ns_fat")
                         .transform.missing.fill()
                         .transform.temporal.tlag(1)
                         .transform.missing.fill()
                        )
            .with_column(Column("acled_ns_tlag_2", from_table = "acled2_cm", from_column = "acled_os_fat")
                         .transform.missing.fill()
                         .transform.temporal.tlag(2)
                         .transform.missing.fill()
                        )
            ...
            # 12-month decay dummy of independent variables
            .with_column(Column("ged_ns_decay_24_time_since", from_table = "ged2_cm", from_column = "ged_ns_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.time_since()
                         .transform.temporal.decay(24)
                        )
             .with_column(Column("ged_os_decay_24_time_since", from_table = "ged2_cm", from_column = "ged_os_best_sum_nokgi")
                         .transform.missing.fill()
                         .transform.temporal.time_since()
                         .transform.temporal.decay(24)
                        )
             .with_column(Column("acled_sb_decay_24_time_since", from_table = "acled2_cm", from_column = "acled_sb_fat")
                         .transform.missing.fill()
                         .transform.temporal.time_since()
                         .transform.temporal.decay(24)
                        )
             .with_column(Column("acled_os_decay_24_time_since", from_table = "acled2_cm", from_column = "acled_os_fat")
                         .transform.missing.fill()
                         .transform.temporal.time_since()
                         .transform.temporal.decay(24)
                        )
             .with_column(Column("acled_ns_decay_24_time_since", from_table = "acled2_cm", from_column = "acled_ns_fat")
                         .transform.missing.fill()
                         .transform.temporal.time_since()
                         .transform.temporal.decay(24)
                        )
         ...
         # From WDI
            ...
            .describe("""Fatalities conflict history, cm level
                ...
                Predicting non-logged fatalities using conflict predictors, ACLED as dependent variable
...
qs = (Queryset("hh_greatest_hits", "country_month")
...
qs = (Queryset("Fatalities001_aquastat", "country_month")
...
qs = (Queryset("Fatalities001_faostat", "country_month")
...
qs = (Queryset("Fatalities001_faoprices", "country_month")
...
qs = (Queryset("Fatalities001_imfweo", "country_month")
